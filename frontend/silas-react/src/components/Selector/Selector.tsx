...
import { OptionType } from '../SelectorOption/SelectorOption';
...
const Selector:React.FC<SelectorProps> = ({ id, label, options, value, onChange }) => {

  return (
    <div id={id} className="mr-3 flex-grow">
      ...
      >
        ...
        >
          {options.map((option) => {
            return <SelectorOption option={option} />;
          })}
        </select>
